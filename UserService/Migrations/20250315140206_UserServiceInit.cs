...
{
    /// <inheritdoc />
    public partial class UserServiceInit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserRelationships_Users_FollowerId",
                        column: x => x.FollowerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserRelationships_Users_FollowingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StreamMetadata", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StreamMetadata_LiveStream_StreamId",
                        column: x => x.StreamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StreamMetadata_StreamId",
                table: "StreamMetadata",
                column: "StreamId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserRelationships_FollowerId_FollowingId",
                table: "UserRelationships",
                columns: new[] { "FollowerId", "FollowingId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserRelationships_FollowingId",
                table: "UserRelationships",
                column: "FollowingId");
